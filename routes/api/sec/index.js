...
router.post('/signin', async (req, res, next) => {
    try {
      const {email, pswd, name, middlename, lastname, age, stdyPlace} = req.body;
      let userAdded = await SecModel.createNewUser(email, pswd, name, middlename, lastname, age, stdyPlace);
